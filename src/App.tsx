...
function App() {
  ...
  if (questions.length === 0) {
    return (
      <Layout>
        <div className="mx-auto w-full max-w-3xl rounded-3xl border border-rose-300/60 bg-white p-6 text-slate-700 shadow-lg shadow-rose-100/80 dark:border-rose-500/40 dark:bg-slate-900/80 dark:text-slate-300 dark:shadow-slate-950/40">
  ...
  return (
    <Layout>
      <header className="flex flex-col gap-6 rounded-3xl border border-slate-200 bg-white/90 p-8 shadow-lg shadow-slate-200/60 transition-colors dark:border-slate-800 dark:bg-gradient-to-br dark:from-slate-900/80 dark:via-slate-900/60 dark:to-slate-950/90 dark:shadow-slate-950/40">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-500 dark:text-slate-400">
              PulsePrep
            </p>
            <h1 className="mt-2 text-3xl font-semibold text-slate-900 sm:text-4xl dark:text-white">
          ...
          <div className="flex flex-wrap items-center gap-3 sm:flex-col sm:items-end">
            <div className="inline-flex items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-xs text-slate-500 dark:border-slate-800 dark:bg-slate-950/70 dark:text-slate-300">
      ...
      {mode === 'home' && (
        <section className="rounded-3xl border border-slate-200 bg-white/90 p-8 text-center shadow-lg shadow-slate-200/60 transition-colors dark:border-slate-800 dark:bg-slate-900/70 dark:shadow-slate-950/40">
      ...
      {mode === 'session' && currentQuestion && (
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4 rounded-3xl border border-slate-200 bg-white/90 p-5 transition-colors dark:border-slate-800 dark:bg-slate-900/60">
